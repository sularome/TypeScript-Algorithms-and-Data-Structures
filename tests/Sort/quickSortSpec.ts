...
describe("quicksort sort", function () {
    ...
    it("should reverse  sort", function () {
        expect(quickSort([1, 4, 2, 3], (a, b) => a < b)).toEqual([4, 3, 2, 1]);
        expect(quickSort([11, 4, 2, 3], (a, b) => a < b)).toEqual([11, 4, 3, 2]);
        expect(quickSort([5, 2, 4, 6, 1, 3], (a, b) => a < b)).toEqual([6, 5, 4, 3, 2, 1]);
    });

    it("should work for any kind of objects", function () {
        expect(quickSort(["a", "b", "a", "C", "d"], (a, b) => a > b)).toEqual(["C", "a", "a", "b", "d"]);
